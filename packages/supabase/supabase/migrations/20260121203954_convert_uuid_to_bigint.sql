...
--
-- IMPORTANT: This is a destructive migration that should only be run when
...
-- profiles table (keep user_id FK since it stays UUID)
-- profiles.user_id -> users.id stays UUID
...
-- =============================================================================
-- STEP 7: Update helper functions to return BIGINT
-- =============================================================================
...
-- =============================================================================
-- STEP 8: Update the handle_new_user trigger function
-- =============================================================================
