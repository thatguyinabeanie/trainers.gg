...
DROP TABLE IF EXISTS "public"."tournament_registration_pokemon" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_invitations" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_pairings" CASCADE;
...
DROP TABLE IF EXISTS "public"."tournament_player_stats" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_opponent_history" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_events" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_registrations" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_phases" CASCADE;
DROP TABLE IF EXISTS "public"."tournaments" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_template_phases" CASCADE;
DROP TABLE IF EXISTS "public"."tournament_templates" CASCADE;
DROP TABLE IF EXISTS "public"."team_pokemon" CASCADE;
DROP TABLE IF EXISTS "public"."teams" CASCADE;
DROP TABLE IF EXISTS "public"."pokemon" CASCADE;
DROP TABLE IF EXISTS "public"."profile_group_roles" CASCADE;
...
-- END OF PART 1
-- Part 2 will contain CREATE TABLE statements
-- =============================================================================
-- CREATE TABLE STATEMENTS (Part 2 - First Half)
-- =============================================================================
-- Tables: users, profiles, organizations, organization_members,
--         organization_invitations, organization_requests, groups, group_roles,
--         roles, permissions, role_permissions, profile_group_roles,
--         feature_usage, subscriptions, rate_limits
-- =============================================================================

-- -----------------------------------------------------------------------------
-- users
-- id stays as uuid (must match auth.users.id)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- profiles
-- id becomes bigint, user_id stays uuid
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- organizations
-- id becomes bigint, owner_profile_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- id becomes bigint, organization_id becomes bigint, profile_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- id becomes bigint, organization_id becomes bigint, profile refs become bigint
-- -----------------------------------------------------------------------------
...
-- id becomes bigint, profile refs become bigint, created_organization_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- groups
-- id becomes bigint, organization_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- group_roles
-- id becomes bigint, group_id becomes bigint, role_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- role_permissions
-- id becomes bigint, role_id becomes bigint, permission_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- profile_group_roles
-- id becomes bigint, profile_id becomes bigint, group_role_id becomes bigint
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- PART 3: POKEMON / TEAMS / TOURNAMENTS TABLES
-- =============================================================================
...
-- =============================================================================
-- PART 4: CONSTRAINTS, INDEXES, TRIGGERS, RLS POLICIES, AND GRANTS
-- =============================================================================
