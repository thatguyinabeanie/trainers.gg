...
END $$;
-- =============================================================================
-- Pokemon and Teams Tables (IDEMPOTENT)
-- =============================================================================
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_pkey') THEN
        ALTER TABLE ONLY "public"."pokemon" ADD CONSTRAINT "pokemon_pkey" PRIMARY KEY ("id");
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_pkey') THEN
        ALTER TABLE ONLY "public"."team_pokemon" ADD CONSTRAINT "team_pokemon_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
BEGIN
    -- EV constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ev_total_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "ev_total_check" 
            CHECK ((((((("ev_hp" + "ev_attack") + "ev_defense") + "ev_special_attack") + "ev_special_defense") + "ev_speed") <= 510));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_hp_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_hp_check" CHECK ((("ev_hp" >= 0) AND ("ev_hp" <= 252)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_attack_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_attack_check" CHECK ((("ev_attack" >= 0) AND ("ev_attack" <= 252)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_defense_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_defense_check" CHECK ((("ev_defense" >= 0) AND ("ev_defense" <= 252)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_special_attack_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_special_attack_check" CHECK ((("ev_special_attack" >= 0) AND ("ev_special_attack" <= 252)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_special_defense_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_special_defense_check" CHECK ((("ev_special_defense" >= 0) AND ("ev_special_defense" <= 252)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_ev_speed_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_ev_speed_check" CHECK ((("ev_speed" >= 0) AND ("ev_speed" <= 252)));
    END IF;
    
    -- IV constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_hp_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_hp_check" CHECK ((("iv_hp" >= 0) AND ("iv_hp" <= 31)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_attack_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_attack_check" CHECK ((("iv_attack" >= 0) AND ("iv_attack" <= 31)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_defense_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_defense_check" CHECK ((("iv_defense" >= 0) AND ("iv_defense" <= 31)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_special_attack_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_special_attack_check" CHECK ((("iv_special_attack" >= 0) AND ("iv_special_attack" <= 31)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_special_defense_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_special_defense_check" CHECK ((("iv_special_defense" >= 0) AND ("iv_special_defense" <= 31)));
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'pokemon_iv_speed_check') THEN
        ALTER TABLE "public"."pokemon" ADD CONSTRAINT "pokemon_iv_speed_check" CHECK ((("iv_speed" >= 0) AND ("iv_speed" <= 31)));
    END IF;
    
    -- Team pokemon position constraint
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_team_position_check') THEN
        ALTER TABLE "public"."team_pokemon" ADD CONSTRAINT "team_pokemon_team_position_check" CHECK ((("team_position" >= 1) AND ("team_position" <= 6)));
    END IF;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_team_id_pokemon_id_key') THEN
        ALTER TABLE ONLY "public"."team_pokemon" ADD CONSTRAINT "team_pokemon_team_id_pokemon_id_key" UNIQUE ("team_id", "pokemon_id");
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_team_id_team_position_key') THEN
        ALTER TABLE ONLY "public"."team_pokemon" ADD CONSTRAINT "team_pokemon_team_id_team_position_key" UNIQUE ("team_id", "team_position");
    END IF;
END $$;
...
BEGIN
    ...
    -- team_pokemon -> teams
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_team_id_fkey') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'team_pokemon_pokemon_id_fkey') THEN
        ALTER TABLE ONLY "public"."team_pokemon"
