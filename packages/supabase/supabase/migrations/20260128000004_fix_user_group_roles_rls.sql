-- Fix RLS policies for user_group_roles table
-- The previous migration had incorrect join conditions that referenced
-- user_group_roles.group_role_id incorrectly within the policy context.
-- This migration drops and recreates the policies with proper subquery patterns.
