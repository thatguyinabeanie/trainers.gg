...
--
-- Context: The display_name column was removed from the alts table.
-- This migration updates the handle_new_user() trigger function to stop
-- inserting display_name when creating new alt records.
...
BEGIN
  ...
  -- Create alt record (main alt for the user) - removed display_name
