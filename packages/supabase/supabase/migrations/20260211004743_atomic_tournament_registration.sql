-- =============================================================================
-- Atomic tournament registration: register_for_tournament_atomic() RPC
-- =============================================================================
-- Atomically registers a player for a tournament, preventing TOCTOU race
-- conditions when checking max_participants capacity. Uses row-level locking
-- to ensure the count check and insert happen atomically.
--
-- Validates:
-- - User is authenticated
-- - Not already registered
-- - Tournament is open for registration
-- - Capacity constraints (registered vs waitlist)
--
-- Returns: jsonb with success/error + registration details
