...
/**
 * getPublicTournamentStandings (auto-injected with server client)
 */
...
/**
 * getPublicPhaseRoundsWithMatches (auto-injected with server client)
 */
...
/**
 * getPublicTournamentPlayerStats (auto-injected with server client)
 */
