...
3. **Present findings to user**
   - **Direct match found:** "This looks like it maps to TGG-XXX (_title_). Options: (a) Update it with details from this work, (b) Skip"
...
- Injects reminder text: _"This commit touched `apps/web/`. If this is a new feature or significant change, consider running `/mobile-parity` to check for mobile parity tickets."_
...
- If changes exist, injects: _"This branch has `apps/web/` changes. If you've added new features, run `/mobile-parity` to check for mobile parity tickets."_
