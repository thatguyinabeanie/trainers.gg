          ...
          {showForm && (
            <div className="bg-primary/5 border-primary/20 mb-8 rounded-lg border-l-4 p-5 text-sm">
              ...
              <p className="text-muted-foreground mt-2">
                ...
                welcoming, inclusive, and free of toxicity, harassment, or
                bigotry.
              </p>
              <p className="text-muted-foreground mt-3">
                ...
                <strong className="text-foreground">
                  don&apos;t be a bigot, don&apos;t be a jerk, and be kind to
                  others
                </strong>
                .
              </p>
              ...
              <p className="text-muted-foreground mt-3">
                We want trainers.gg to be a place where every trainer feels
                welcome.
              </p>
            </div>
          )}
