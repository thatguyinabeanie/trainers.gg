...
describe("createFlagAction", () => {
  ...
  it("returns a generic error when the query throws an Error", async () => {
    ...
    expect(result).toEqual({
      success: false,
      error: expect.stringContaining("Error creating feature flag"),
    });
  });
...
describe("updateFlagAction", () => {
  ...
  it("returns a generic error when the query throws an Error", async () => {
    ...
    expect(result).toEqual({
      success: false,
      error: expect.stringContaining("Error updating feature flag"),
    });
  });
...
describe("deleteFlagAction", () => {
  ...
  it("returns a generic error when the query throws an Error", async () => {
    ...
    expect(result).toEqual({
      success: false,
      error: expect.stringContaining("Error deleting feature flag"),
    });
  });
...
describe("updateAnnouncementAction", () => {
  ...
  it("returns a generic error when the query throws an Error", async () => {
    ...
    expect(result).toEqual({
      success: false,
      error: expect.stringContaining("Error updating announcement"),
    });
  });
...
describe("deleteAnnouncementAction", () => {
  ...
  it("returns a generic error when the query throws an Error", async () => {
    ...
    expect(result).toEqual({
      success: false,
      error: expect.stringContaining("Error deleting announcement"),
    });
  });
