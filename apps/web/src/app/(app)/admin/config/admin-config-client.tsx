...
/** Shape of a site role row (matches the `roles` table). */
interface SiteRole {
  id: number;
  name: string;
...
/** Shape of a site admin row (user_roles joined with user + role). */
interface SiteAdmin {
  id: number;
...
// =============================================================================
// Site Roles Section (pure display, data from server)
// =============================================================================

interface SiteRolesSectionProps {
  siteRoles: SiteRole[];
  siteAdmins: SiteAdmin[];
}

function SiteRolesSection({ siteRoles, siteAdmins }: SiteRolesSectionProps) {
  return (
...
// =============================================================================
// AdminConfigPageClient — "use client" island
// Props come from the server component (one-shot service-role reads).
// =============================================================================
...
export function AdminConfigPageClient({
  siteRoles,
  siteAdmins,
}: AdminConfigPageClientProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ========== Site Roles Section ========== */}
      <SiteRolesSection siteRoles={siteRoles} siteAdmins={siteAdmins} />
