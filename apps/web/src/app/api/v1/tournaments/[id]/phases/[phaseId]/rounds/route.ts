/**
 * GET /api/v1/tournaments/[id]/phases/[phaseId]/rounds
 *
 * Returns rounds with match-count stats for a phase (used for round selection
 * dropdowns and status indicators in the pairings view).
 *
...
import { getCachedPhaseRoundsWithStats } from "@/lib/data/tournaments-endpoints";
...
export async function GET(
  ...
  const rounds = await getCachedPhaseRoundsWithStats(phaseIdNum, tournamentId);
