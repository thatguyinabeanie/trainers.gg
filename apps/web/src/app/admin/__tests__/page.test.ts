 ...
 * logic. These functions are internal to the page module, so we replicate
 * the exact implementations here and test them in isolation.
 */

// ── Constants (replicated from page.tsx) ────────────────────────────
...
const DEFAULT_FILL = "oklch(0.705 0.015 286.07)";

// ── Helper functions (replicated from page.tsx) ─────────────────────
...
// ── Data transformation (replicated from DonutBreakdownCard's useMemo) ──
