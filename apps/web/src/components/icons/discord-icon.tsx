...
export function DiscordIcon({
  ...
  // Decorative by default (icon alongside a text label). When a consumer
  // supplies an accessible name — e.g., for an icon-only button — drop the
  // default `aria-hidden` so the label is actually announced. Consumers can
  // still override `aria-hidden` explicitly via props.
