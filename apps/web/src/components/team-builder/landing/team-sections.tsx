 ...
 *
 * All sections are always wrapped in SortableContext so rows are always
 * draggable (onto alt pills, folder-rail nodes, or reordering in custom mode).
 * The parent DndContext + drag routing live in TeamsLandingClient (§10.3).
 */
        ...
        return (
          <div key={section.id} data-section-id={section.id}>
            ...
            {/* Section rows — role="list" here (not on the keyboard-nav outer
                ...
                Always wrapped in SortableContext so rows are draggable in
                every sort mode (onto alt pills, folder nodes, or reordering).
                The DndContext and drag routing live in TeamsLandingClient. */}
            {!isCollapsed && (
              <div
                role="list"
