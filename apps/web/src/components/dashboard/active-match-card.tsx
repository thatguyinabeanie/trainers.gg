    ...
    <Card className="border-primary/30 from-primary/10 via-background to-background relative overflow-hidden bg-gradient-to-br">
      ...
      <CardContent className="relative space-y-4">
        ...
        <Link
          ...
          className={cn(
            "bg-primary text-primary-foreground hover:bg-primary/90 group relative inline-flex h-11 w-full items-center justify-center gap-2 overflow-hidden rounded-lg px-4 text-sm font-bold tracking-wide uppercase transition-all"
          )}
        >
