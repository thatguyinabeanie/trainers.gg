...
| **Team Builder**                     | **Live**               | Public builder (no account required) with a damage calculator, dynamic speed tiers (every Pokémon in the format ranked by your team's real effective speed, recomputed live as you tweak a build), and type coverage analysis. Import teams from Showdown paste or Poképaste. Team sheet parsing, validation, and legality checking. Integrated with tournament registration — saved teams sync to your account.                                                                                                                                                                                                  |
...
| **Data Aggregation**                 | **Under Construction** | Import tournament data from RK9.gg, Limitless, and official Pokemon tournament sources. Display standings and team sheets natively. Feed all imported data into analytics and the team builder.                                                                                              |
