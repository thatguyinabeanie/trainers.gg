...
description: Use when creating UI components, working with design tokens, or applying design principles in the web app
---
...
## Design Token System (@trainers/theme)

Shared OKLCH color primitives, semantic tokens, and CSS variable utilities. Used by both Tailwind (web) and Tamagui (mobile).
