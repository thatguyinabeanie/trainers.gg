...
| **Calc mechanics for Champions abilities** | (not a bundle field — lives in `vendor/damage-calc`) | `vendor/damage-calc/calc/src/` | Upstream `@smogon/calc` if it ever adds Champions support |
