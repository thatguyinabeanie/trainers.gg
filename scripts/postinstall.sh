...
# =============================================================================
# Supabase demo keys (placeholders — setup-local.sh replaces with live keys)
# =============================================================================
...
CRON_SECRET=$(openssl rand -hex 32 || head -c 32 /dev/urandom | xxd -p || echo "local-dev-cron-secret-replace-me")
