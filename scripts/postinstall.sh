...
# =============================================================================
# Supabase demo keys (deterministic, never change for local dev)
# =============================================================================
# These are the default keys generated by `supabase init` / `supabase start`
# for the local demo project. They are NOT secrets - they only work locally.
